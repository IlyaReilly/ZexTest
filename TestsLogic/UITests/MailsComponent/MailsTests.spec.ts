...
test.describe('Mails tests', async () => {
  ...
  test('TC252. Reply mail. Reply mail should be visible in the Sent folder', async ({pageManager, apiManager}) => {
    ...
    await expect(pageManager.mailsList.Elements.UnreadMessageIcon.locator('"4"'), 'Reply mail should be visible in the Sent folder').toBeVisible();
  });
  ...
  test('TC253. Get a reply mail. Reply mail should be visible in the Inbox folder', async ({pageManager, apiManager}) => {
    ...
    await expect(pageManager.mailsList.Elements.UnreadMessageIcon.locator('"4"'), 'Reply mail should be visible in the Inbox folder').toBeVisible();
  });
  ...
  test("TC254. Forward mail. Forwarded mail should be visible in the Sent folder", async ({pageManager, apiManager}) => {
    ...
    await expect(pageManager.mailsList.Elements.UnreadMessageIcon.locator('"4"'), 'Forwarded mail should be visible in the Sent folder').toBeVisible();
  });
  ...
  test('TC255. Get a forwarded mail. Forwarded mail should be visible in the Inbox folder', async ({pageManager, apiManager}) => {
    ...
    await expect(pageManager.mailsList.Elements.UnreadMessageIcon.locator('"4"'), 'Forwarded mail should be visible in the Inbox folder').toBeVisible();
  });
