...
export class FilesList extends BaseApplicationPage {
  ...
  Elements = {
    ...
    FileName: this.Containers.MainContainer.locator(`${this.InheritedFields.ListFileReactLocator} >> [class^="Text__Comp"][color="text"]`),
    FileExtension: this.Containers.MainContainer.locator(this.InheritedFields.ListFileReactLocator).locator('[class^="Container__ContainerEl"] > [class*="NodeListItem"]'),
    FileSize: this.Containers.MainContainer.locator(`${this.InheritedFields.ListFileReactLocator} >> [class^=Padding__Comp] [class*=NodeListItem]`),
    FlagIcon: this.Containers.MainContainer.locator('[data-testid="icon: Flag"]'),
    DefinedByNameFile: (unicFileName) => this.page.locator(this.InheritedFields.ListFileReactLocator, {hasText: `${unicFileName}`}),
    ...
    FileExtensionFilteredByFileName: (fileName) => this.Containers.MainContainer.locator(this.InheritedFields.ListFileReactLocator).filter({hasText: `${fileName}`}).locator('[class^="Container__ContainerEl"] > [class*="NodeListItem"]'),
  };
