...
export class CreateMailsAPI extends BaseAPI {
  ...
  async SendMsgWithCcRequest(subject, from, recipient, mailBody, secondRecipient) {
    let id = '';
  ...
  FormingMsgWithCcRequestBody(requestType, subject, from, to, body, secondRecipient) {
    return {
      Body: {
        [requestType]: {
          _jsns: 'urn:zimbraMail',
  ...
  FormingMsgWithBccRequestBody(requestType, subject, from, to, body, secondRecipient) {
    return {
      Body: {
        [requestType]: {
          _jsns: 'urn:zimbraMail',
